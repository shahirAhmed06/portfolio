...
media:
  - type: image
    src: "/images/research/microtechnology-lab/hero.png"
    alt: "One of the best CV results I got: no noise, perfect peaks, textbook CV"
    caption: "One of the best CV results I got: no noise, perfect peaks, textbook CV"
  - type: image
    src: "/images/research/microtechnology-lab/2.jpeg"
    alt: "One of our microfluidic experimental setup"
    caption: "One of our microfluidic experimental setup"
  - type: image
    src: "/images/research/microtechnology-lab/3.png"
    alt: "Multichannel potentiostat PCB"
    caption: "Multichannel potentiostat PCB"
---
...
The output of all this is data — a lot of it. I have analyzed 100+ experimental datasets in **Origin**, **MATLAB**, and the [electrochemical analyzer](/projects/electrochemical-analyzer) I am building to replace that workflow, producing the plots we use to benchmark electrode performance against each other and to validate whether the system is actually hitting the sensitivity thresholds we claim it is.
