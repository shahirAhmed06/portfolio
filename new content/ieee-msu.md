---
title: "IEEE MSU Student Branch"
slug: "ieee-msu"
organization: "IEEE MSU Student Branch"
role: "Technical Director"
location: "East Lansing, MI"
startDate: 2026-02-01
endDate: null
current: true
summary: "Running hands-on workshops that take students from a blank KiCad schematic to a soldered, firmware-flashed board they built themselves."
heroImage: ""
---

## 00.01 — Context

I have been **Technical Director** of the **IEEE MSU Student Branch** since February 2026. The role is what it sounds like: I am responsible for the branch's technical programming — the workshops where students actually build something.

The gap I care about closing is a specific one. An EE curriculum will teach you circuit theory for two years before it lets you touch a board, and the result is students who can solve for a node voltage but have never held a soldering iron or opened a schematic editor. Those are not advanced skills. They are the entry fee, and nothing about them is hard once someone shows you.

---

## 00.02 — The workshop

I co-led a hands-on workshop that takes students through the **entire path from nothing to a working PCB**:
...
- **C firmware development** — because a board that does nothing is a coaster.
